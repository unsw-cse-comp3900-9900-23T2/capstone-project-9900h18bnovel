          ...
          <g id="laptop">
            ...
            <g id="laptop__keyboard">
              ...
              <polygon points="237.6 264.9 221.4 261.7 230.4 259.4 246.8 262.6 237.6 264.9" stroke="#000"
                stroke-linecap="round" stroke-linejoin="round" stroke-width="1.2"></polygon>
              <polygon points="474.8 312 250 267.3 259.4 265.1 487.7 309.6 474.8 312" stroke="#000" stroke-linecap="round"
                stroke-linejoin="round" stroke-width="1.2"></polygon>
              <polygon points="412 308.5 204.4 266 213.1 263.8 423.9 306.3 412 308.5" stroke="#000" stroke-linecap="round"
                stroke-linejoin="round" stroke-width="1.2"></polygon>
            ...
            <el-menu>
              ...
              <div style="padding: 20px;">
                <el-button @click="goCreateBook" type="primary" :icon="Plus" style="width: 100%; font-size: large;">Create
                  Book</el-button>
                <el-switch v-model="editing" width="235" inline-prompt
                  style="--el-switch-on-color: #13ce66; --el-switch-off-color: #409eff" active-text="Editing"
                  inactive-text="Enable Edit Mode" size="large" />
              </div>
              <el-sub-menu>
                <template #title>
                  <span>My Books</span>
                </template>
                <el-menu-item v-for="(item, index) in authorBooks" :key="index" :index="index" @click="goEditBook(item)">
                  {{ item.bookName }}
                </el-menu-item>
              </el-sub-menu>
            </el-menu>
              ...
              <el-tabs>
                <el-tab-pane label="Book">
                  <div style="width: 100%; display:flex; justify-content:center;">
                    <img :src="selectedBook.picUrl" style="height:300px; border-radius: 10px;">
                  </div>
                  <div v-show="editing">
                  ...
                  <el-descriptions direction="vertical" :column="2" border>
                    ...
                    <el-descriptions-item label="Name">
                      <el-input v-model="selectedBook.bookName" :disabled="!editing"></el-input>
                    </el-descriptions-item>

                    <el-descriptions-item label="Work Direction">
                      <el-radio-group v-model="selectedBook.workDirection">
                        <el-radio label="1" size="large" :disabled="!editing" border>Male Lead</el-radio>
                        <el-radio label="2" size="large" :disabled="!editing" border>Female Lead</el-radio>
                      </el-radio-group>
                    </el-descriptions-item>

                    <el-descriptions-item label="Description" :span="2">
                      <el-input v-model="selectedBook.bookDesc" :disabled="!editing" :autosize="{ minRows: 2 }"
                        type="textarea"></el-input>
                    </el-descriptions-item>

                    <el-descriptions-item label="Genre" :span="2">
                      <el-radio-group :disabled="!editing" v-model="selectedBook.categoryId" @change="cateIdChangeName">
                    ...
                    <el-descriptions-item label="Book status">
                      <el-radio-group v-model="selectedBook.bookStatus">
                        <el-radio label="0" size="large" :disabled="!editing" border>Ongoing</el-radio>
                        <el-radio label="1" size="large" :disabled="!editing" border>Completed</el-radio>
                      </el-radio-group>
                    </el-descriptions-item>
                ...
                <el-tab-pane label="Chapter">
                  ...
                  <div v-if="chapters.length > 0">
                    ...
                    <el-collapse v-model="activeName" accordion>
                      <el-collapse-item v-for="(item, index) in chapters" :key="index" :title="item.chapterName"
                        @click="getContent(item.id)">
                        {{ chapterContent }}
                        <el-button v-show="editing" @click="isEditChapter = true" type="primary" :icon="Edit" circle />
                        <el-button v-show="editing" @click="deleteChapter" type="danger" :icon="Delete" circle />
                        <el-dialog v-model="isEditChapter" width="60%">
                          <template #header>
                          ...
                          <div>
                            <h2>Content:</h2>
                            <el-input v-model="editChapterContent" :autosize="{ minRows: 20 }" type="textarea"></el-input>
                          </div>
                          <template #footer>
